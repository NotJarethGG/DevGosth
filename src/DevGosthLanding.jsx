...
const MOCK_METRICS = [
  { label: "Visitas / mes", value: "1,240", change: "+12%" },
  { label: "Conversión", value: "8.3%", change: "+2.1%" },
  { label: "Velocidad", value: "98/100", change: "Óptimo" },
];
          ...
          <div className="hero__mockup">
            <div className="mockup">
              ...
              <div className="mockup__header">
                <div className="mockup__header-label">Proyecto activo</div>
                <div className="mockup__header-url">miclienta.com</div>
              </div>

              {MOCK_METRICS.map((metric, i) => (
                <div key={i} className="mockup__metric">
                  <div className="mockup__metric-label">{metric.label}</div>
                  <div className="mockup__metric-row">
                    <span className="mockup__metric-value">{metric.value}</span>
                    <span className="mockup__metric-change">{metric.change}</span>
                  </div>
                  <div className="mockup__metric-bar">
                    <div
                      className="mockup__metric-bar-fill"
                      style={{ width: `${60 + i * 15}%` }}
                    />
                  </div>
                </div>
              ...
              <div className="mockup__footer">
                ...
                <span className="mockup__footer-text">En línea · Última actualización hace 2h</span>
              </div>
            </div>
          </div>
        </div>
